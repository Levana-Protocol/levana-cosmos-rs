...
impl Cosmos {
    ...
    pub async fn store_code(
        ...
        gzip_encoder.write_all(&wasm_byte_code).map_err(|err|crate::Error::WasmGzipFailed { source: err })?;
        let wasm_byte_code = gzip_encoder.finish().map_err(|err|crate::Error::WasmGzipFailed { source: err })?;
